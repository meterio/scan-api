...
KnowExchange.set(
  '0xd0d9cd5aa98efcaeee2e065ddb8538fa977bc8eb',
...
KnowExchange.set(
  '0xfe64e37dfc7d64743d9351260fa99073c840452b',
...
KnowExchange.set(
  '0x003bfdd8117f9388f82a1101a2c6f4745803c350',
  'Bithumb (Cold wallet 2)'
);
KnowExchange.set(
  '0x572494959983627cff1f2fe0ef44231ddae2451a',
  'Bithumb (Cold wallet)'
);
KnowExchange.set(
  '0x2cf496da57192011e01448dae61895c0f4bc5d68',
  'Bithumb (Hot wallet)'
);
...
KnowExchange.set(
  '0xda4d4530d856623dc820427f71e9aa601075f02d',
  'KuCoin (Out wallet)'
);
KnowExchange.set(
  '0x9037aa63d3860b708a31df9d372709322d6a2911',
  'KuCoin (Warm wallet)'
);
KnowExchange.set(
  '0x34e106fcd890331b70be740ca2660aafe9c602d9',
  'KuCoin (Cold wallet)'
);
KnowExchange.set(
  '0x94d85ade017a805396a19327ac4c8e5a347c8a72',
  'LaToken (current hot wallet)'
);
KnowExchange.set(
  '0xa4e7fe69f7a188ddb1af24fa2fd227fb0dd07d83',
  'LaToken 1 (first wallet)'
);
KnowExchange.set(
  '0x68e29026cf3a6b6e3fce24e9fcc2865f39c884d7',
...
KnowExchange.set(
  '0x14db82cc90a6cbe876cc24adcfe2953cfdacfee9',
  'OceanEx (BAG wallet)'
);
KnowExchange.set(
  '0x8979cdda17e1afd32c73b65145484abe03f46725',
  'OceanEx (DBET wallet 1)'
);
KnowExchange.set(
  '0x8e9e08eed34cf829158fab863f99c0225d31e123',
  'OceanEx (DBET wallet 2)'
);
KnowExchange.set(
  '0x10fa7c0e8d4e2c04b600918ebdac06823bcd3dee',
  'OceanEx (ICO/Cold wallet)'
);
KnowExchange.set(
  '0x254afc2490d83b1a56fe621cd708f89456472d87',
  'OceanEx (JUR wallet 2)'
);
KnowExchange.set(
  '0x589f83e66272d3d783c06dd6a66cb3b3549e5453',
  'OceanEx (OCE wallet 1)'
);
KnowExchange.set(
  '0x9d30a969297cb008e2d777135155e89a35b5dff4',
  'OceanEx (OCE wallet 2)'
);
KnowExchange.set(
  '0x4e28e3f74c5974c8d18611d5323ae8a1344c3e73',
  'OceanEx (PLA wallet 1)'
);
KnowExchange.set(
  '0x45685fb104772e9b6421202ed2d7309d7a6dc32d',
  'OceanEx (PLA wallet 2)'
);
KnowExchange.set(
  '0xee12ecae8a1fea9d4279640bb87072c9db76198d',
  'OceanEx (SHA wallet 1)'
);
KnowExchange.set(
  '0xe6f432d44de32f22a0b6c743e448e4421653393e',
  'OceanEx (SHA wallet 2)'
);
KnowExchange.set(
  '0xc4c8bf14dbb11703e39aca0d6e51ebf2e93882d7',
  'OceanEx (TIC wallet)'
);
KnowExchange.set(
  '0x284b9e222c461e32c2fa17053e2ea207041cffa0',
  'OceanEx (VTHO wallet)'
);
KnowExchange.set(
...
KnowExchange.set(
  '0x64594d4e1c9296c15384441fc1640d9812b51ffd',
  'OceanEx 3 (Custodian wallet old)'
);
KnowExchange.set(
  '0xd96ae915d6e28640c373640fd57fad8022c53965',
  'OceanEx 4 (Custodian wallet new)'
);
KnowExchange.set(
  '0xa760bdcbf6c2935d2f1591a38f23251619f802ad',
  'OceanEx VTHO (Sender)'
);
KnowExchange.set(
  '0x21d54bcf0142c5a3286a7ec7449ad9c4fd5a68f2',
  'RightBTC (PLA wallet)'
);
KnowExchange.set(
...
KnowExchange.set(
  ...
  'vexchange.io (SHA contract)'
);
KnowExchange.set(
  '0x992cd19c2f33d5f5569f17ff047063b3b0ff1ada',
  'vexchange.io (TIC contract)'
);
KnowExchange.set(
...
KnowExchange.set(
  ...
  'vexchange.io (YEET custom contract)'
);
KnowExchange.set(
  '0x534bd48d7cfb0602ea3708cfddacfeb2242c843e',
  'vtho.exchange (Contract)'
);
KnowExchange.set(
  '0x012345403c589a51b02ee27bd41339f6114aac6a',
  'vtho.exchange (Intermediary)'
);
